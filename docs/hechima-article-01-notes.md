...
**状態: 執筆支援資料(2026-07-20 作成 / 2026-07-23 追補)**。数値・日付・URL はすべて
リポジトリ実物(ファイルサイズ・golden 実行・VENDOR.md・依頼書)で裏取り済み。執筆時は
ここだけ見れば事実確認が済むようにしてある。骨子は会話で確定済み(Note 6 節 / Zenn 8 章)。
